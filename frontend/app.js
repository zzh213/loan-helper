...
function makePoster(data) {
  ...
  g.addColorStop(0, "#6491c7"); g.addColorStop(0.5, "#80a3cf"); g.addColorStop(1, "#6d8aa6");
  ...
  if (subsidy && subsidy.after_subsidy) {
    ...
    ctx.fillStyle = "#2c5484"; ctx.font = "bold 22px sans-serif"; ctx.textAlign = "center";
